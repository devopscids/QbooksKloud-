...
#             'EditParts00':          _(""),
            ...
            'NewRevision08':        _("The document is newer than stored on CIDS Design.\nRemove from PWS and download it again."),
            ...
            'NewDocRevision06':     _("The document is newer than stored on CIDS Design.\nRemove from PWS and download it again."),
            ...
            'NewMinorRevision06':   _("The document is newer than stored on CIDS Design.\nRemove from PWS and download it again."),
            ...
            'LeftTrayMessages03':   _("logged on CIDS Design server"),
...
class plm_mail(models.Model):
    ...
    def SendFSCheck(self, repository=False):
        ...
        if receivers:
            ...
            subject="Periodic Check of CIDS Design File System" if (ratio>20) else "CRITICAL Check CIDS Design File System"
