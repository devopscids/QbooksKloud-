...
#    'live_test_url': 'https://youtu.be/_r51MCn34nY',
    # 'live_test_url': 'https://youtu.be/lXJ1G5W0qf4',
    'live_test_url': 'https://probuseappdemo.com/probuse_apps/construction_contracting_issue_tracking/750',#'https://youtu.be/H0yO034kbzo',
    'category' : 'Services/Project',
    'data':[
        'report/support_request.xml',
        'datas/helpdesk_support_sequence.xml',
        # 'datas/mail_template_ticket.xml',
        # 'datas/mail_template_datas.xml',
        'datas/mail_template_new.xml',
