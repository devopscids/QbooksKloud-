...
{
    'name': 'Meeting Minutes for Construction and Contracting Projects',
    'currency': 'EUR',
    'price': 20.0,
    'version': '4.6',
    'depends': [
    ...
    'summary': 'Project Meeting Minutes for Construction and Contracting Projects and Jobs',
    'description': """
...
odoo Construction
    ...
    'live_test_url': 'https://probuseappdemo.com/probuse_apps/project_meeting_minutes/1038',#'https://youtu.be/6kSOA7z7ZaE',
    'data': [
