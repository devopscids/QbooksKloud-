...
class TransmittalDocument(models.Model):
    ...
    def action_send_transmittal_document(self):
        ...
        try:
            ...
            template_id = self.env['ir.model.data']._xmlid_to_res_id('transmittals_communication_document.email_template_transmittal_submittal_doc', raise_if_not_found=False)
        except ValueError:
            template_id = False
        try:
