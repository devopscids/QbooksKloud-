...
workshop machine repair
    ...
    # 'live_test_url': 'https://youtu.be/N6zs-yj-Lyc',
    'live_test_url': 'https://probuseappdemo.com/probuse_apps/construction_contracting_repair/264',#'https://youtu.be/oGdRPOEeeF8',
    'data':[
