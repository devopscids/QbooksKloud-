...
dict_theme_color_style = {
    ...
    'color_2_1': {
        ...
        #        'body_background_color': '#ffffff',
        #        'header_font_color': '#a1a1a1',
        'header_hover_color': '#FFBC00',
        'header_active_color': '#FFBC00',
        #        'h1_color': '#4E4E4E',
        #        'h2_color': '#4E4E4E',
        #        'h3_color': '#4E4E4E',
        #        'h4_color': '#4E4E4E',
...
#        'body_font_color': '#4E4E4E',
#        'body_background_color': '#F9F9F9',
#         'sidebar_background_color': '#FFBC00',
#          'sidebar_font_color': '#5a5858',
#        'sidebar_font_hover_color': '#ffffff',
...
#
    ...
    def update_theme_color(self, primary_color_id, primary_hover_id, primary_active_id, gradient_color, secondary_color_id, secondary_hover_id, secondary_active_id,
                           ...
                           h5_size, h6_size, p_size, button_style, separator_style, separator_color, icon_style, dual_tone_icon_color_1 , dual_tone_icon_color_2 ,is_button_with_icon_text, is_button_with_box_shadow,
                           ...
                           tab_style, tab_style_mobile, horizontal_tab_style, vertical_tab_style, form_element_style, search_style, breadcrumb_style,chatter_position,loading_style,progress_style,progress_height,progress_color,checkbox_style,radio_btn_style,scrollbar_style,discuss_chatter_style, discuss_chatter_style_image, backend_all_icon_style):
        theme_setting_rec = request.env['sh.back.theme.config.settings'].sudo().search([
            ('id', '=', 1)], limit=1)
        is_used_google_font = False
