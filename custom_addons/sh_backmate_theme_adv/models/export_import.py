    ...
    def import_data(self):
        ...
        if self.import_file:
            ...
            for row in csv_reader:
                ...
                if key =='sidebar_background_image' or key == 'discuss_chatter_style_image' or key == 'body_background_image' or key == 'login_page_background_image':
                    value = value[2:]
                    value = value[:-1]
                else:
                    print("\n\n\n 000000000000000000000",key, value)
             
                   
                backmate_setting_dic[key] = value
                
                
            print("\n\n\n\ backmate_setting_dic",backmate_setting_dic)
            ...
            #    print("\n\n\n\n sheet.cell(row, 0) ",sheet.cell(row, 0).value, sheet.cell(row, 1).value)
...
'chatter_position',
'checkbox_style',
'discuss_chatter_style',
'discuss_chatter_style_image',
'display_name',
...
'icon_style',
'is_button_with_box_shadow',
'is_button_with_icon_text',
'is_sticky_chatter',
'is_sticky_form',
'is_sticky_list',
...
'backend_all_icon_style'
        ...
        #                                                 })
        # export_id = self.env['download.data.file'].sudo().create({
        #     'contact_file': base64.encodebytes(fp.getvalue()),
        #     'file_name': filename,
        #     'file': attachment_id.id
        # })
