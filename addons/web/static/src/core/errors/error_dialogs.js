...
ErrorDialog.title = _lt("CIDS Error");

// -----------------------------------------------------------------------------
// Client Error Dialog
// -----------------------------------------------------------------------------
export class ClientErrorDialog extends ErrorDialog {}
ClientErrorDialog.title = _lt("CIDS Client Error");

// -----------------------------------------------------------------------------
// Network Error Dialog
// -----------------------------------------------------------------------------
export class NetworkErrorDialog extends ErrorDialog {}
NetworkErrorDialog.title = _lt("CIDS Network Error");
...
export class RPCErrorDialog extends ErrorDialog {
    ...
    inferTitle() {
        ...
        switch (this.props.type) {
            case "server":
                this.title = this.env._t("CIDS Server Error");
                break;
            case "script":
                this.title = this.env._t("CIDS Client Error");
                break;
            case "network":
                this.title = this.env._t("CIDS Network Error");
                break;
        }
    }
...
export class WarningDialog extends Dialog {
    setup() {
        super.setup();
        this.title = this.env._t("CIDS Warning");
        this.inferTitle();
...
export class RedirectWarningDialog extends Dialog {
    setup() {
        ...
        this.title = capitalize(subType) || this.env._t("CIDS Warning");
        this.message = message;
...
SessionExpiredDialog.title = _lt("CIDS Session Expired");
